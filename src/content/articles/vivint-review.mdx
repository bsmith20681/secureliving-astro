...
<figure>
  ...
  <figcaption>The Vivint Smart Hub panel mounted in my home. The touchscreen makes navigating the system way easier than a traditional keypad.</figcaption>
</figure>
...
<figure>
  <Image src={vivintOutdoorCamera} alt="Vivint Outdoor Camera with Floodlight" />
  <figcaption>The Vivint Outdoor Camera Pro with the floodlight add-on installed outside my house.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>The detection zone settings in the Vivint app. You can adjust the area and sensitivity to cut down on false alerts.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>The outdoor camera in deter mode at night. The red ring lights up and the camera whistles when it detects someone.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>One of Vivint's wireless door/window sensors. These replaced the hardwired sensors that weren't working in my home.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>The Vivint smart lock installed on my front door. You can control it from the app, the panel, or the keypad on the lock itself.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>The Nest thermostat connected to my Vivint system. It adjusts temperature based on whether you're home or away.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Creating an automation shortcut in the Vivint app. You pick a trigger and then set the actions you want to fire.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>The Vivint mobile app home screen. Everything from cameras to door locks to the thermostat is accessible from one place.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Locking the front door remotely from the Vivint app. I use this all the time when I forget to lock up on my way out.</figcaption>
</figure>
