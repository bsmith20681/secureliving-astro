...
So, if you're interested in getting a qoute, you can <a href={companyData.website}>visit their website</a> or give them a call at <a href={companyData.phoneUnformatted}>{companyData.phone}</a>
