...
<strong>> > Vivint Promo:</strong> <a href={vivintData.website}>{vivintData.promo}</a> or call <a href={vivintData.phoneUnformatted}>{vivintData.phone}</a>
...
So, if you're interested in getting a qoute, you can <a href={vivintData.website}>visit their website</a> or give them a call at <a href={vivintData.phoneUnformatted}>{vivintData.phone}</a>
