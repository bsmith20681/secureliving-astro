...
That changed when they launched the self setup option. Now when you call ADT, you have two choices: get the system professionally installed (which is a different system with different pricing, and [I've reviewed that separately](/adt-review/)), or order the DIY version and install it yourself.
